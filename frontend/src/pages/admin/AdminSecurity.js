...
const AdminSecurity = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/change-password`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        toast.success('Şifre başarıyla güncellendi! Lütfen yeni şifre ile tekrar giriş yapın.');
