      ...
      <div style={styles.content}>
        <div style={styles.card}>
          <div style={styles.cardHeader}>
            ...
            <h1 style={styles.title}>Müşteri Kaydı</h1>
            <p style={styles.subtitle}>Hesap oluşturarak tekliflerinizi takip edin</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.formGroup}>
              ...
              <input
                ...
                minLength={6}
              />
              <span style={styles.hint}>En az 6 karakter olmalıdır</span>
            </div>
            ...
            <div style={styles.footer}>
              <p style={styles.footerText}>
                ...
                <Link to="/musteri-giris" style={styles.link}>
                  Giriş Yapın
                </Link>
              </p>
            </div>
